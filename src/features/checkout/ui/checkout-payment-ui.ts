...
export const CHECKOUT_PAYMENT_CARD_BADGE_PADDING_MOBILE_PX = 3;
export const CHECKOUT_PAYMENT_CARD_BADGE_BOX_HEIGHT_MOBILE_PX = 26;
...
export const CHECKOUT_PAYMENT_CARD_BADGE_RADIUS_MOBILE_PX = 4;
export const CHECKOUT_PAYMENT_CARD_BADGES_GAP_MOBILE_PX = 3;
