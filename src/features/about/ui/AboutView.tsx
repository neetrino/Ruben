...
export function AboutView({ locale, copy }: AboutViewProps) {
  ...
  return (
    <div className="about-page-root relative z-0 -mx-4 -mt-2 min-h-full bg-white px-2 pt-3 pb-3 sm:-mx-6 sm:px-3 sm:pt-4 sm:pb-4 lg:-mx-8 lg:-mb-10 lg:px-4 lg:pt-5 lg:pb-5">
