  ...
  return (
    <section className="relative z-0 hidden bg-white pt-0 pb-12 sm:pb-20 lg:block lg:min-h-[820px] lg:pb-8">
      ...
      */}
      ...
      <m.div
        className="relative z-10 mx-auto grid w-full max-w-[1440px] items-start gap-4 px-6 sm:px-10 lg:grid-cols-[minmax(0,520px)_minmax(0,1fr)] lg:items-center lg:gap-0 lg:px-[105px]"
        initial="hidden"
        animate="show"
        variants={heroStaggerVariants}
      >
        <div className="relative z-20 max-w-xl translate-y-6 pt-1 lg:pt-3">
          ...
          <m.div
            className="mt-6 border-l-[6px] border-[var(--brand)] pl-7 sm:mt-8"
          ...
          <m.div className="mt-6 sm:mt-8" variants={heroItemVariants}>
